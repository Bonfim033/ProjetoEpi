...
import 'package:projeto_epi/Models/colaborador_epi.dart';
import 'package:projeto_epi/Models/epi.dart';
...
class ApiService {
  ...
  Future<Epi> detalhesEpi(int idEpi) async {
    final response =
        await http.get(Uri.parse('${AppUrl.baseUrl}api/Epi/$idEpi'), headers: {
      'Content-Type': 'application/json',
      'Authorization': 'Bearer $token',
    });
